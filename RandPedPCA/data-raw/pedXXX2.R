## code to prepare `pedMeta` and `pedLinv` dataset goes here
...
#genIBDS <- SIMplyBee::calcBeeGRMIbs(x = data$genoIBS, sex=rep("F", 2650))
#pedG <- genIBDS
#saveRDS(pedG, "~/temp/pedG.rds")
#saveRDS(data$genoIBS, "~/temp/pedGeno.rds")
#str(genIBDG)
